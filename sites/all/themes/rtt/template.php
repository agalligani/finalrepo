 ...
 * Breadcrumb themeing
 */
function rtt_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
 ...
 * Node preprocessing
 */
function rtt_preprocess_node(&$vars) {
 ...
 * Page preprocessing
 */
function rtt_preprocess_page(&$vars) {
 ...
 */
function rtt_preprocess_comment(&$vars) {
  global $user;
 ...
 */
function rtt_preprocess_user_profile_item(&$vars) {
 ...
 */
function rtt_shoutbox_post($shout, $links = array(), $alter_row_color=TRUE) {
  global $user;
...
function rtt_item_list($items = array(), $title = NULL, $type = 'ul', $attributes = NULL) {
...
function rtt_preprocess_block($variables) {
