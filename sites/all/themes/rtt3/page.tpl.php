...
<head>
  ...
  <?php if (arg(0) != 'admin') { ?>
    <link rel="stylesheet" type="text/css" href="/sites/all/themes/rtt/jquery-ui-multiselect-widget/jquery.multiselect.css" />
    <script type="text/javascript" src="/sites/all/themes/rtt/jquery-ui-1.8.11/jquery-1.5.1.min.js"></script>
    <script type="text/javascript" src="/sites/all/themes/rtt/jquery-ui-1.8.11/ui/minified/jquery-ui.min.js"></script>
    <script type="text/javascript" src="/sites/all/themes/rtt/jquery-ui-multiselect-widget/jquery.multiselect.js"></script>
