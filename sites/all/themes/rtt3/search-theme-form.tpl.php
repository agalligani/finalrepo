...
<div id="search" class="container-inline">
  <input class="search-input form-text" type="text" maxlength="128" name="search_theme_form" id="edit-search-theme-form-header"  size="15" value="<?php print t('Search...') ?>" >
  <input id="search_header" class="search_submit" type="submit" name="op" value="<?php print t('') ?>"  />
