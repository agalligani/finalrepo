 ...
 * Breadcrumb themeing
 */
function rtt3_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
 ...
 * Node preprocessing
 */
function rtt3_preprocess_node(&$vars) {
 ...
 * Page preprocessing
 */
function rtt3_preprocess_page(&$vars) {
 ...
 */
function rtt3_preprocess_comment(&$vars) {
  global $user;
 ...
 */
function rtt3_preprocess_user_profile_item(&$vars) {
 ...
 */
function rtt3_shoutbox_post($shout, $links = array(), $alter_row_color=TRUE) {
  global $user;
...
function rtt3_item_list($items = array(), $title = NULL, $type = 'ul', $attributes = NULL) {
...
function rtt3_preprocess_block($variables) {
